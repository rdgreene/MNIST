function [ weightsHid, weightsOut, epochClassErrors, epochVectorErrors, epochValClassErrors, epochValVectorErrors ] = trainNN( hiddenLayerSize, batchSize, epochs, alpha, mu, trainingData, targetVectors, rngModifier, foldValData, foldValLabels)
